...
#Test case for starts_with_non_number
    def test_starts_with_non_number(self):
        ...
        self.assertEqual(pythonBasics3.starts_with_non_number("! is for yelling"), True)

        self.assertEqual(pythonBasics3.starts_with_non_number("_ is different than -"), True)

        self.assertEqual(pythonBasics3.starts_with_non_number("777 is a lucky number"), False)
...
#Test case for multiple_words
    def test_multiple_words(self):
        ...
        # Please add three more test cases following the order above
        self.assertEqual(pythonBasics3.multiple_words("another test!"), True)

        self.assertEqual(pythonBasics3.multiple_words("More words here"), True)

        self.assertEqual(pythonBasics3.multiple_words("19 55"), True)
